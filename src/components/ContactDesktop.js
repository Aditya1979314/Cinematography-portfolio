...
export function ContactDesktop(){
    ...
    return (
        <div className="grid grid-cols-2 grid-rows-10 px-28 py-16">

            <div className="col-start-1 col-span-1 row-start-1 row-span-1">
            <h1 className="text-6xl text-white font-bold text-center">Get in touch</h1>
            </div>

            <div className="col-start-1 col-span-1 row-start-3 row-span-9">
            ...
            <div className="bg-contact-phone bg-cover bg-center bg-no-repeat h-full row-start-1 row-span-10">
